...
#define kXYAnimationViewState_start 1
#define kXYAnimationViewState_pause 2
#define kXYAnimationViewState_resume 4
#define kXYAnimationViewState_reset 2
#define kXYAnimationViewState_stop 5
